...
import { getProductsByMerchant } from "@/lib/api";
...
export default function MerchantClient({
  ...
  useEffect(() => {
    // Extract unique brands and categories from initial products
  ...
  const applyFilters = () => {
    ...
    router.push(`/magazin/${merchant}?${params_url.toString()}`);
  ...
  const resetFilters = () => {
    ...
    setSortBy('date-desc');
    router.push(`/magazin/${merchant}?page=1&sort=date-desc`);
        ...
        <div className="mb-6">
          ...
          {merchantDescription && (
            <div
              ...
              dangerouslySetInnerHTML={{ __html: merchantDescription }}
            />
          )}
              ...
              <>
                ...
                {totalPages > 1 && (
                  <div className="flex justify-center items-center gap-2">
                    ...
                    {currentPage > 1 && (
                      <Link
                        href={`/magazin/${merchant}?page=${currentPage - 1}&sort=${sortBy}`}
                    ...
                    <div className="flex gap-2">
                      {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                        ...
                        return (
                          <Link
                            key={pageNum}
                            href={`/magazin/${merchant}?page=${pageNum}&sort=${sortBy}`}
        ...
        {merchantSeoContent && (
          <div className="mt-12 bg-white rounded-lg shadow-md p-6">
            <div
              ...
              dangerouslySetInnerHTML={{ __html: merchantSeoContent }}
            />
          </div>
        )}
      </main>
